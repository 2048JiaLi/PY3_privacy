...
%LDP机制下的快速FIM方法-    标题
\title{Fast frequent itemset mining under Local Differential Privacy*\\
...
Due to its unique advantages, DP has been widely studied by the academia and industry. For example, Google, Microsoft, apple and other companies use this technology to protect users' privacy, and at the same time, mobile phones aggregate data, so as to improve service quality. And the U.S. government will complete a census of 330 million U.S. residents by 2020, while keeping their identities secret. If the mission goes well, it will be the largest application ever.
